    ...
    switch (type) {
      case 'organization':
        return {
          ...
          url: data.url || 'https://cubecraft-438.preview.emergentagent.com',
          logo: data.logo || 'https://cubecraft-438.preview.emergentagent.com/logo.png',
          contactPoint: {
            '@type': 'ContactPoint',
      ...
      case 'article':
        return {
          ...
          publisher: {
            ...
            logo: {
              '@type': 'ImageObject',
              url: 'https://cubecraft-438.preview.emergentagent.com/logo.png',
            },
          },
      ...
      case 'event':
        return {
          ...
          organizer: {
            '@type': 'Organization',
            name: 'A-Cube Mental Health Platform',
            url: 'https://cubecraft-438.preview.emergentagent.com',
          },
