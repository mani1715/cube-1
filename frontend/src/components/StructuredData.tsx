    ...
    switch (type) {
      case 'organization':
        return {
          ...
          url: data.url || 'https://cubetracker-2.preview.emergentagent.com',
          logo: data.logo || 'https://cubetracker-2.preview.emergentagent.com/logo.png',
          contactPoint: {
            '@type': 'ContactPoint',
      ...
      case 'article':
        return {
          ...
          publisher: {
            ...
            logo: {
              '@type': 'ImageObject',
              url: 'https://cubetracker-2.preview.emergentagent.com/logo.png',
            },
          },
      ...
      case 'event':
        return {
          ...
          organizer: {
            '@type': 'Organization',
            name: 'A-Cube Mental Health Platform',
            url: 'https://cubetracker-2.preview.emergentagent.com',
          },
